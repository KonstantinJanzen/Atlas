...
This module can be installed like any other Drupal module:
 ...
 3. Set the content types that should be available as a clickable element on the configuration page (admin/config/node_creation_links).
...
Set the content types that should be available as a clickable element on the configuration page (admin/config/node_creation_links).
By default no content types are selected. Nothing is added to the user menu block if no content types are set.
